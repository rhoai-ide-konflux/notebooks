...
application = "rhoai-ide-konflux-notebooks"

namespace_name = "rhoai-ide-konflux-tenant"
    ...
    for task, direct_deps in tree.items():
        ...
        for i, dep in enumerate(reversed(deps)):
            ...
            build_container_tasks.append(build_container(
                name_suffix="-" + str(i),
                output_image="quay.io/redhat-user-workloads/" + namespace_name + "/" + dep_name + ":on-pr-{{revision}}",
